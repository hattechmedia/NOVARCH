...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <nav
          className="mx-auto flex h-20 sm:h-22 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8"
          aria-label="Main navigation"
        >
          {/* Logo with logo4F.png icon (N) + custom stylized OVARCH wordmark */}
          <Link href="/" className="flex items-center gap-1.5 flex-shrink-0 group" aria-label="NOVARCH — Home">
            <Image
              ...
              height={100}
              priority
              className="h-14 sm:h-16 lg:h-[68px] w-auto object-contain transition-transform duration-200 group-hover:scale-105 drop-shadow-[0_0_12px_rgba(56,178,216,0.35)]"
            />
            <Image
              ...
              height={32}
              priority
              className="h-6 sm:h-7 lg:h-[30px] w-auto object-contain -ml-1 sm:-ml-1.5 transition-opacity duration-200 group-hover:opacity-95"
            />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <div className="ml-4 pl-4 border-l border-border flex items-center gap-4">
              <Button
                ...
                variant="primary"
                size="sm"
                className="px-5 py-2 text-sm font-semibold shadow-sm shadow-[#1E5FBF]/20"
              >
                Start a Project
              </Button>
            </div>
