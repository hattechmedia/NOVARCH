      ...
      <Container className="pt-16 pb-12">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            <Link href="/" aria-label="NOVARCH — Home" className="flex items-center gap-3 mb-6">
              <Image
              ...
              />
              <span className="text-2xl font-extrabold tracking-wider text-white uppercase font-sans">
                NOVARCH
              </span>
            </Link>
