...
export function ProcessSection() {
  ...
  // Scroll listener to update active step sequentially without box skipping
  React.useEffect(() => {
    const handleScroll = () => {
      ...
      // Force step-by-step incremental change (max 1 step per scroll update)
              ...
              <div className="lg:col-span-7 flex flex-col lg:-mt-2.5">
                <div className="flex-1 p-8 sm:p-10 rounded-2xl bg-navy-800 border border-navy-700 text-white shadow-2xl relative overflow-hidden flex flex-col justify-between transition-all duration-300 min-h-[500px]">
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base text-white/80 leading-relaxed mb-8 font-medium drop-shadow-sm">
                      {current.detail}
                    </p>
                  </div>
