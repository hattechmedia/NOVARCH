    ...
    <section className="relative overflow-hidden bg-background py-20 lg:py-28 text-white">
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-4xl text-center flex flex-col items-center">
          ...
          <Reveal delay={300}>
            <p className="text-lg sm:text-xl text-blue-light leading-relaxed mb-10 max-w-2xl">
          ...
          <Reveal delay={400}>
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto justify-center mb-12">
              <Button href="/contact" variant="primary" size="lg" className="w-full sm:w-auto group bg-blue hover:bg-blue-600">
                Start a Project
